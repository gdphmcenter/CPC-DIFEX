                ...
                if phase != 'target_val':
                    ...
                    if args.adabn:
                        torch.save(self.model.module.state_dict() if self.device_count > 1 else self.model.state_dict(),
                                   os.path.join(self.save_dir, '{}-model_temp.pth'.format(epoch)))
                        self.model_eval.load_state_dict(torch.load(os.path.join(self.save_dir, '{}-model_temp.pth'.format(epoch))))
