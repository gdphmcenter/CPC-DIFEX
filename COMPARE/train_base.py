...
def parse_args():
    ...
    # adabn parameters
    # parser.add_argument('--adabn', type=bool, default=False, help='whether using adabn')#basis方法
    parser.add_argument('--adabn', type=bool, default=True, help='whether using adabn')#adabn方法
