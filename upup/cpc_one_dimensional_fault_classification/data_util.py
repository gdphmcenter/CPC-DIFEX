...
class MatHandler_8192(object):
    ...
    def load_dataset(self):
        ...
        # 取后两百个数据作为验证集
        X_train, X_val = X_train[:-30], X_train[-30:]
        y_train, y_val = y_train[:-30], y_train[-30:]
...
class MatHandler(object):
    ...
    def load_dataset(self):
        ...
        # 取后两百个数据作为验证集
        X_train, X_val = X_train[:-247], X_train[-247:]
        y_train, y_val = y_train[:-247], y_train[-247:]
...
class TEST_MatHandler(object):
    ...
    def load_dataset(self):
        ...
        # 取后两百个数据作为验证集
        X_train, X_val = X_train[:-176], X_train[-176:]
        y_train, y_val = y_train[:-176], y_train[-176:]
...
class DANN_MatHandler(object):
    ...
    def load_dataset(self):
        ...
        # 取后两百个数据作为验证集
        X_train, X_val = X_train[:-497], X_train[-497:]
        y_train, y_val = y_train[:-497], y_train[-497:]
