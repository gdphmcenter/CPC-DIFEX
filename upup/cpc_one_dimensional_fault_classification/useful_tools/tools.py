...
# def plot_with_labels(train, labels, clusters_number = 10):
#     """
#     绘制聚类图
#     DONE
#     """
...
#     # plt.legend(loc=[1, 0])
#     plt.savefig('./picture/encoder_new_DANN_10_epochs_16_batchs.png')
#     plt.show()
...
def plot_with_labels(train, labels, clusters_number=4):
    ...
    legend = ax.legend(loc=[1, 0])
    # plt.legend(loc=[1, 0])
    plt.savefig('./picture/encoder_new_10_epochs_16_batchs.png')


def plot_with_labels_DANN(train, labels, clusters_number=4):
    """
    绘制聚类图
    DONE
    """
